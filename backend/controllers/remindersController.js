...
const ELECTION_DATES = {
  registrationOpens: "2024-03-01",
  registrationCloses: "2024-03-15",
  nominationOpens: "2024-04-01",
  nominationCloses: "2024-04-10",
  votingDay: "2024-05-15",
  countingDay: "2024-05-16",
  resultDay: "2024-05-17"
};
...
const getWizardGuidance = async (req, res) => {
  try {
    ...
    if (ageNum < 18) {
      ...
      guidance.recommendations.push("As a young voter, your participation is crucial for India's future!");
    } else if (ageNum >= 60) {
      guidance.recommendations.push("Senior citizens get priority assistance at polling stations.");
      guidance.recommendations.push("You may be eligible for postal voting if mobility is an issue.");
    }
    ...
    if (needsAssistance === 'yes') {
      guidance.recommendations.push("You can request assistance under Rule 49MA of the Conduct of Election Rules, 1961");
